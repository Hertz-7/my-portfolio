...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${bricolage.variable} ${ibmPlexSans.variable} ${ibmPlexMono.variable} antialiased h-full`}
    >
      <body className="min-h-full bg-[var(--ground)] text-[var(--prose)]">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-[var(--accent)] focus:text-[var(--ground)] focus:text-[11px] focus:tracking-[0.2em] focus:uppercase focus:rounded-[2px]"
        >
          Skip to content
        </a>
        {children}
