...
const SOCIALS = [
  { label: "GitHub", href: "https://github.com/Hertz-7", icon: GithubIcon },
  { label: "LinkedIn", href: "https://linkedin.com/in/mohammad-aosaf", icon: LinkedinIcon },
  { label: "Email", href: "mailto:mohammadaosaf@gmail.com", icon: Mail },
