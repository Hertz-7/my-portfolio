...
export function About() {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 text-[var(--slate)] text-[1.0625rem] leading-[1.7]">
        <motion.p
        ...
        >
          ...
          <strong className="text-[var(--light)] font-semibold">
            MindHYVE.ai
          </strong>
        ...
        >
          ...
          <strong className="text-[var(--light)] font-semibold">QLU.ai</strong>
